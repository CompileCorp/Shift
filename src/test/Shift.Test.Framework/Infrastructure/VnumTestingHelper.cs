    ...
    where TEnum : struct, Enum
{
    ...
    /// </summary>
    public void Vnum_Instances_Must_Have_Unique_Codes(string? codePattern = null)
    {
    ...
    {
        // Arrange
        var enumValues = Enum.GetValues<TEnum>().Where(e => Convert.ToInt64(e) > 0).ToArray();
    ...
    public void All_Enum_Instances_Must_Convert_To_Vnum()
    {
        ...
        {
            if (Convert.ToInt64(enumInstance) == 0) continue; // Skip default enum value
